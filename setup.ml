...
let setup_t =
  {
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/mmottl/sqlite3-ocaml.git";
                      src_repo_browser =
                        Some "https://github.com/mmottl/sqlite3-ocaml";
                      src_repo_module = None;
                      src_repo_branch = None;
                      src_repo_tag = Some "v$(pkg_version)";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\tf\154\159ви ;Веv\150\148\021.\014";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
