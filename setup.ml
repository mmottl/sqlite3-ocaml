...
# 21 "/Users/mmottl/.opam/4.00.1/build/oasis.0.3.0/src/plugins/custom/CustomPlugin.ml"
...
let setup_t =
  {
       ...
       [
          ...
          ("test_exec",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_exec", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)];
                 });
          ("test_fun",
     ...
     package =
       {
          ...
          copyrights =
            [
               "(C) 2007-2010 Jane Street Holding LLC <opensource@janestreet.com>";
          ...
          homepage = Some "https://bitbucket.org/mmottl/sqlite3-ocaml";
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "test_agg.ml"; });
               Test
                 ({
                     cs_name = "test_agg";
                     cs_data = PropList.Data.create ();
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "test_db.ml"; });
               Test
                 ({
                     cs_name = "test_db";
                     cs_data = PropList.Data.create ();
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "test_exec.ml"; });
               Test
                 ({
                     cs_name = "test_exec";
                     cs_data = PropList.Data.create ();
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "test_fun.ml"; });
               Test
                 ({
                     cs_name = "test_fun";
                     cs_data = PropList.Data.create ();
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "test_stmt.ml"; });
               Test
                 ({
                     cs_name = "test_stmt";
                     cs_data = PropList.Data.create ();
               ...
               Doc
                 ({
                     ...
                     },
                   {
                      ...
                      doc_title = "API reference for sqlite3-ocaml";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               SrcRepo
                 ({
                     ...
                     },
                   {
                      src_repo_type = Hg;
                      src_repo_location =
                        "ssh://hg@bitbucket.org/mmottl/sqlite3-ocaml";
                      src_repo_browser =
                        Some "https://bitbucket.org/mmottl/sqlite3-ocaml";
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "t‘\159~\r ·ˆ?Â\002WÚ\147Õ\146";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
